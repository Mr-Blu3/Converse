								...
								<div class="frontpage_form">
									...
									<form method="post" action="./user/register">
										...
										<div id="frontpage_form_radio">
											<label><input type="radio" value="http://138.68.143.251/Converse/views/img/default_male.png" name="avatar" id="male">Male</label>
											<label><input type="radio" value="http://138.68.143.251/Converse/views/img/default_female.png" name="avatar" id="female">Female</label>
											<label><input type="radio" value="http://138.68.143.251/Converse/views/img/default_none.jpg" name="avatar" id="none" checked>n/a</label>
											<!--
